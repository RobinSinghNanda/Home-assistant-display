...
const char S_UNAVIABLE[] = "unavailable";
...
const char S_CONFIGURE_CARDS[]        PROGMEM = D_CONFIGURE_CARDS;\
...
const uint32_t VERSION_MARKER[] PROGMEM = { MARKER_START, SOFTWARE_VERSION, MARKER_END };

const char S_HTML_LANGUAGE[] PROGMEM = D_HTML_LANGUAGE;
